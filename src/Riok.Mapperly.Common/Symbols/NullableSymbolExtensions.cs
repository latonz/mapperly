...
{
    public static bool HasSameOrStricterNullability(this ITypeSymbol symbol, ITypeSymbol other)
    {
        return symbol.NullableAnnotation == NullableAnnotation.NotAnnotated || symbol.NullableAnnotation == other.NullableAnnotation;
    }

    public static bool TryGetNonNullable(this ITypeSymbol symbol, [NotNullWhen(true)] out ITypeSymbol? nonNullable)
    {
    ...
    public static bool NonNullable(this ITypeSymbol symbol, out ITypeSymbol nonNullable)
    {
    ...
    public static ITypeSymbol NonNullable(this ITypeSymbol symbol)
    {
        NonNullable(symbol, out var nonNullable);
        return nonNullable;
    }

    public static bool IsNullable(this ITypeSymbol symbol) => symbol.IsNullableReferenceType() || symbol.IsNullableValueType();

    public static bool IsNullableReferenceType(this ITypeSymbol symbol) => symbol.NullableAnnotation.IsNullable();

    public static bool IsNullableValueType(this ITypeSymbol symbol) => symbol.NonNullableValueType() != null;

    public static ITypeSymbol? NonNullableValueType(this ITypeSymbol symbol)
    {
    ...
    public static bool? IsNullable(this ITypeParameterSymbol typeParameter)
    {
    ...
    public static bool IsNullableUpgraded(this ITypeSymbol symbol)
    {
    ...
    public static bool IsNullable(this NullableAnnotation nullable) =>
        nullable is NullableAnnotation.Annotated or NullableAnnotation.None;

    public static NullableAnnotation Upgrade(this NullableAnnotation nullable) =>
